        ...
        <div className="flex flex-col gap-8 items-center justify-center w-full">
          ...
          <div className="flex flex-col items-start w-full gap-1">
            ...
            <div className="h-[58px] relative w-full">
              <div className="absolute bg-white inset-[10px_0_0_0] flex items-center justify-between px-3 py-[14px] rounded-[12px] border border-[#dad9d8]">
                ...
                <input
                  className="flex-1 min-w-0 font-['IRANSansXFaNum:Regular',sans-serif] text-[#3b3b3b] text-[clamp(13px,1.2vw,16px)] text-right bg-transparent outline-none pl-2"
                  dir="auto"
